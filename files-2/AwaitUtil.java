 ...
 * <h2>Method index</h2>
 * <ul>
 *   <li>{@link #waitUntil} - simple "wait until this becomes true."</li>
 *   <li>{@link #waitForValue} - wait for a value to satisfy a matcher, and return it.</li>
 *   <li>{@link #waitUntilConsistentlyTrue} - guard against flapping/false-positive reads.</li>
 *   <li>{@link #untilAsserted} - wait for a multi-field assertion block to pass.</li>
 *   <li>{@link #waitUntilQuietly} - non-throwing variant, for the rare case
 *       where "did it happen in time" is itself the assertion.</li>
 * </ul>
 *
 * <p>See the team guide (WaitUtil-AwaitUtil-Guide.md) for when to use this
 * class vs {@link WaitUtil}.
 */
public final class AwaitUtil {
    ...
    // =================================================================
    // Eventual-consistency specific patterns
    // =================================================================
    ...
    // =================================================================
    // Non-throwing variant + internal helpers
    // =================================================================
